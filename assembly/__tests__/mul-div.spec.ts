...
const a = MpZ.from('0xFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAED');
const b = MpZ.from('0x0000DEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEAD');
...
describe('div', () => {
  ...
  it('returns correct values for large numbers', () => {
    assertSame(MpZ.from('0xFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAED') / MpZ.from('0x00000000BEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEAD'), 5734240797);
    assertSame(MpZ.from('0xFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAEDFEEBDAED') / MpZ.from('0x0000DAEDBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEAD'), 76310);

    assertSame( MpZ.from('0xBEEFDEADBEEFDEADBEEFDEADBEEFDEAD') / MpZ.from('0xBEEFDEADBEEFDEAD'), '18446744073709551617');
    assertSame( MpZ.from('0xDEADBEEFDEADBEEF00000000') / MpZ.from('0xDEADBEEFDEADBEEF0000'), 0x10000);

    assertSame( MpZ.from('542101086242752217003726400434970855712890625') / MpZ.from('100000000000000000000'), '5421010862427522170037264');
    assertSame( MpZ.from('542101086242752217003726400434970855712890625') / MpZ.from('100000000000000000000'), '5421010862427522170037264');

    assertSame( fact(1000) / fact(500),
